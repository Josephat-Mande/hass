...
const partners = [
  {
    name: "bioMérieux",
    category: "Molecular · Bacteriology · Microbiology · ImmunoAssay",
  ...
  {
    name: "ERBA Mannheim",
    category: "Clinical Chemistry · Hematology · Coagulation · Urinalysis",
...
const stats = [
  { icon: <Building2 className="w-6 h-6" />, value: "2",   label: "Global Partners",   color: brandBlue },
